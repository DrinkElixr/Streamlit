...
def main():
    ...
    mm=st.sidebar.selectbox("What do you want to see?",["Maps","Charts","Both"])
    if mm=="Maps":
        sm=st.multiselect("Which maps would you like to see?",["Colleges by State","All Colleges","Colleges by Town"])
